export default {
    ...
    documentTitle: "Cisalpine Celtic Wordle: Guess the Cisalpine Celtic Word", // Document title translated
    writtenName: "Cisalpine Celtic Wordle", // Written name translated
    charSet: [
        'a', 'b', 'c', 'd', 'e', 'v',
        'g', 'h', 'i', 'θ', 'k', 'l',
        'm', 'n', 'o', 'ś', 'p', 'q', 'r',
